...
<html class="no-js" lang="">
  <head>
    ...
    <style><?php
      ...
      // include('https://fonts.googleapis.com/css?family=Oswald:700|Poppins');
    ?></style>
  ...
  <body>
    <section>
      <nav>
        <h4 class="button" style="font-style: italic;  font-size: 1,5rem;">Nutrition & Motivation</h4>
        <a class="button" href="./Login.php"  style="text-decoration:none ;">Login</a>
        <a class="button" href="#" style="text-decoration:none ;">Sign Up</a>
      </nav>
      <div class="container">
